...
const DonorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Award 10000 credits on load (for testing)
    setTimeout(() => {
      deductCredits(-10000);
      setShowCreditAnimation(true);
      setTimeout(() => setShowCreditAnimation(false), 3000);
    }, 1500);
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Welcome to {user?.organization?.name || 'Impact First Foundation'} Dashboard! 👋
            </h1>
            <p className="text-gray-700 text-lg max-w-2xl">
              Discover funding opportunities, create professional proposals, and track your impact journey all in one place.
            </p>
          </div>
        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pl-14 pr-20 bg-white border border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700"
            />
          ...
          {userCountry && (
            <div className="px-4 py-2 bg-blue-50 border border-blue-100 rounded-xl">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-700 text-sm font-medium">Showing opportunities for {userCountry}</span>
              </div>
            </div>
          )}
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-xl font-bold text-gray-900">Trending Opportunities</h3>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {trendingOpportunities.map((opportunity, index) => (
            ...
            >
              ...
              <p className="text-gray-600 text-sm mb-3">{opportunity.donor}</p>
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center space-x-1 text-orange-600">
                  <Clock className="w-4 h-4" />
                  <span>{opportunity.deadline}</span>
                </div>
                <span className="text-blue-600 font-medium">{opportunity.amount}</span>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <h4 className="text-gray-900 font-semibold mb-2">Professional Proposal</h4>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200 shadow-sm"
      >
        <div className="flex items-center space-x-3 mb-4">
          <div className="p-2 bg-yellow-100 rounded-lg">
            <Lightbulb className="w-5 h-5 text-yellow-600" />
          </div>
          <h3 className="text-xl font-bold text-gray-900">Funding Tips & Insights</h3>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
            <h4 className="font-medium text-gray-900 mb-2">Proposal Success Tip</h4>
            <p className="text-gray-600 text-sm">Focus on clear impact metrics and sustainability plans in your proposals to increase approval chances.</p>
          </div>
          
          <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
            <h4 className="font-medium text-gray-900 mb-2">Trending Sector</h4>
            <p className="text-gray-600 text-sm">Climate resilience funding is up 34% this quarter. Consider highlighting environmental aspects of your work.</p>
          </div>
          
          <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
            <h4 className="font-medium text-gray-900 mb-2">Upcoming Deadline</h4>
            <p className="text-gray-600 text-sm">UNDP Innovation Fund applications close in 14 days. <a href="#" className="text-blue-600">Start your application</a>.</p>
          </div>
        </div>
      </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          >
            <div className="flex items-center space-x-3 mb-2">
              ...
              <h4 className="text-gray-900 font-medium">Expert Consultation</h4>
            </div>
            <p className="text-gray-600 text-sm mb-3">Get personalized assistance from our funding experts</p>
          ...
          >
            <div className="flex items-center space-x-3 mb-2">
              ...
              <h4 className="text-gray-900 font-medium">Proposal Review</h4>
            </div>
            <p className="text-gray-600 text-sm mb-3">Get professional feedback on your grant proposals</p>
