/*
  # Search Bot System for Funding Opportunities

  1. New Tables
    - `search_bots` - Configuration for country-specific search bots
    - `bot_rewards` - Reward system for successful bot searches
    - `search_targets` - Websites, APIs, and sources to search
    - `opportunity_verifications` - Verification records for opportunities
    - `search_statistics` - Performance metrics for the search system
  ...
  3. Indexes
    ...
    - Support for country and sector filtering
*/
...
-- Admins can manage search targets
...
-- Admins can manage opportunity verifications
